...
def normalise_input(user_input):
    ...
    'help'
    """
    user_input = remove_punct(str(user_input))
    user_input = remove_spaces(str(user_input))
...
def menu(exits):
    ...
    while True:
        print_menu(exits)
        player_choice = normalise_input(str(input()))
        if is_valid_exit(exits,player_choice):
